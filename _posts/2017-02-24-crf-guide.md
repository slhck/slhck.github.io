...
For example, here is a figure ([from another post of mine]({% link _posts/2017-03-01-rate-control.md %})) that shows how the bitrate changes for two video clips encoded at different levels (17, 23) of constant QP or CRF:
